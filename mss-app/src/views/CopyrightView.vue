    ...
    <div id="content">
      ...
      <div>
        ...
        <p>
          ...
          audio-visual material on this website) is owned by MattSarzSports.com.
        </p>
        <p>
          <b>Copyright license</b>
        </p>
        <p>
          MattSarzSports.com grants to you a worldwide non-exclusive
        ...
        <p>
          MattSarzSports.com does not grant you any other rights in relation to
          this website or the material on this website. In other words, all
          other rights are reserved.
        </p>
        <p>
          For the avoidance of doubt, you must not adapt, edit, change,
          transform, publish, republish, distribute, redistribute, broadcast,
          rebroadcast or show or play in public this website or the material on
          this website (in any form or media) without MattSarzSports.com's prior
          written permission.
        </p>
        <p>
          <b>Data mining</b>
        ...
        <p>
          MattSarzSports.com takes the protection of its copyright very
          seriously. If MattSarzSports.com discovers that you have used its
          copyright materials in contravention of the license above,
          MattSarzSports.com may bring legal proceedings against you seeking
          ...
          any use of MattSarzSports.com's copyright materials that contravenes
          or may contravene the license above, please report this by email to
          <a href="mailto:footballsked@gmail.com">footballsked@@gmail.com</a>.
        </p>
        <p>
