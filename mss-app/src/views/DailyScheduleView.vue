...
watch(dailyTvGameResult, dailyTvGameValue => {
    if (!!dailyTvGameResult) {
        paramYear = dailyTvGameResult.value?.dailyTvGames ? dailyTvGameResult.value?.dailyTvGames[0].season : '';
        season = sport === 'football' ? (paramYear ?? null) : (`${paramYear.substring(0, 4)}-${paramYear.substring(4)}` ?? null)
                ...
                <div class="container">
                    <div>
                        <span class="blockspan">
                            ...
                            <RouterLink v-if="season" class="mobilespan" :to="`/season/${sport}/${season}`">Season
                                Home
                            </RouterLink>
                        </span>
                        <span class="blockspan">
