...
export const routes: RouteConfig[] = [
  { path: '/', name: 'home', element: <RouteLoader><HomeView /></RouteLoader> },
  { path: '/copyright', element: <RouteLoader><CopyrightView /></RouteLoader> },
  { path: '/archive', element: <RouteLoader><ArchiveView /></RouteLoader> },
  { path: '/season/:sport/:year', element: <RouteLoader><SeasonView /></RouteLoader> },
  { path: '/contract/:conference/:year', element: <RouteLoader><ConferenceGamesView /></RouteLoader> },
  { path: '/tv-windows/:year', element: <RouteLoader><TvWindowsView /></RouteLoader> },
  {
    path: '/schedule/:sport/:year/:week',
    name: 'Weekly',
    element: <RouteLoader><WeeklyScheduleView /></RouteLoader>
  },
  {
    path: '/schedule/:sport/:year/:week/text',
    name: 'Weekly Text',
    element: <RouteLoader><WeeklyTextScheduleView /></RouteLoader>
  },
  { path: '/schedule/:sport/daily', element: <RouteLoader><DailyScheduleView /></RouteLoader> },
  { path: '/schedule/:sport/daily/text', element: <RouteLoader><DailyTextScheduleView /></RouteLoader> }
];
